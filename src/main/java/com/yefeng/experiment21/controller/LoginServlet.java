...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String account=request.getParameter("account");//account可以是手机号，也可以是邮箱，可以是用户名
            String password=request.getParameter("password");
            UserBeanAction uba=new UserBeanAction();
            UserBeanAction uba1=new UserBeanAction();
           boolean flag=uba.login(password,account);
            out.println("<script>");
            if(flag){
                UserBean user=uba1.findUser(account);
                ...
                out.println("alert('用户名或密码错误，请重试！');");
